...
<html>
    <head>
        <meta charset="utf-8">
        <title>{{ config('app.name', 'ignite') }} - @yield('title')</title>
        ...
        @section('scripts')
            ...
            <!-- Ability to customize ignite theme -->
            <link rel="stylesheet" href="/themes/{{ config('theme.admin', 'ignite') }}/css/{{ config('theme.admin', 'ignite') }}.css">
