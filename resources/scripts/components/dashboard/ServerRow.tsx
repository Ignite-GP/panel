                    ...
                    <React.Fragment>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.Cpu size={15} css={tw`text-neutral-600`} />
                        ...
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.PieChart size={15} css={tw`text-neutral-600`} />
                ...
                <div css={tw`hidden col-span-12 sm:flex items-baseline justify-center items-center`}>
                    ...
                    <PlayerCounter uuid={server.uuid} />
                        <div css={tw`flex-1 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.HardDrive size={15} css={tw`text-neutral-600`} />
                                <IconDescription>{bytesToString(stats?.diskUsageInBytes)}</IconDescription>
                            </div>
                        </div>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                                <Icon.Clock size={15} css={tw`text-neutral-600`} />
                                <IconDescription>
